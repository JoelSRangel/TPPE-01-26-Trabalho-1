...
Esse repositório tem como objetivo realizar a confecção do trabalho 1 da disciplina Técnicas de Programação em Plataformas Emergentes , no semestre 01/2026 do calendário da UnB, ministrado pelo docente André Lanna
...
``` bash
git clone [https://github.com/seu-usuario/TPPE-01-26-Trabalho-1.git](https://github.com/seu-usuario/TPPE-01-26-Trabalho-1.git)
